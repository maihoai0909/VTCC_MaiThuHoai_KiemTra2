package com.hoaimt.testcases;

import com.hoaimt.base.BaseTest;
import org.openqa.selenium.By;
import org.testng.Assert;
import org.testng.annotations.Test;

import java.lang.reflect.Method;
import com.hoaimt.base.CaptureHelper;

public class AddNewProduct extends BaseTest {
    @Test
    public void TestAddNewProductSuccess(Method method){
        ...
        //ProductName
        driver.findElement(By.xpath("//input[@placeholder='Product Name']")).sendKeys(product);
        //Category
        ...
        //Unit
        driver.findElement(By.xpath("//input[@name='unit']")).sendKeys("1");
        //Weight
        ...
        sleep(2);
        //SEO Meta Tags
        driver.findElement(By.xpath("//input[@placeholder = 'Meta Title']")).sendKeys("high quality t shirts");
        driver.findElement(By.xpath("//textarea[@name = 'meta_description']")).sendKeys("Both ASKET and Mott & Bow produce high-quality T-shirts off the peg, but ASKET's extensive choice of sizes, including width and length");
        //Xử lý ảnh
        driver.findElement(By.xpath("//label[text()='Meta Image']/following::div")).click();
        sleep(1);
        driver.findElement(By.xpath("//input[@placeholder='Search your files']")).sendKeys("anh");
        sleep(3);
        driver.findElement(By.xpath("//div[@title='anh.png']")).click();
        sleep(1);
        driver.findElement(By.xpath("//button[text()='Add Files']")).click();
        sleep(2);
        //Low Stock Quantity Warning
        driver.findElement(By.xpath("//input[@name = 'low_stock_quantity']")).sendKeys("2");
        ...
        sleep(5);
        //Search
        driver.findElement(By.xpath("//input[@placeholder ='Type & Enter']")).sendKeys(product);
        sleep(2);
        Assert.assertTrue(driver.findElement(By.xpath("//tbody/tr[1]/td[2]")).isDisplayed(), "The Category not display.");
        Assert.assertEquals(driver.findElement(By.xpath("//tbody/tr[1]/td[2]")).getText(),product, "The Category Name not match.");
